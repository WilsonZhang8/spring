...
public class ConventionsTest {
	...
	public static void main(String[] args) {
		...
		//通过方法得到方法返回值名称
		f(Conventions.getVariableNameForReturnType(ReflectionUtils.findMethod(XSDsdfPli_A.class, "aBB_aaSaaAdf")));
		f(Conventions.getVariableNameForReturnType(ReflectionUtils.findMethod(XSDsdfPli_A.class, "aBB_aaSaaAdfStr")));
		f(Conventions.getVariableNameForReturnType(ReflectionUtils.findMethod(XSDsdfPli_A.class, "aBB_aaSaaAdfStr"), ct));
