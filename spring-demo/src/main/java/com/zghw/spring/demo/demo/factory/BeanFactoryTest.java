...
public class BeanFactoryTest {
	...
	public static void printBeanFactoryMethod(BeanFactory beanFactory){
		...
		//静态工厂方法实例对象
		CarFactory carFactory =beanFactory.getBean(CarFactory.class);
		//动态改变静态方法实例对象
		carFactory =beanFactory.getBean(CarFactory.class,"设置过的==");
		CarSub carSub=beanFactory.getBean(CarSub.class,"动态工厂方法创建的对象",22222);
